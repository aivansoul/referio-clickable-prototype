...
export function DesignSystemScreen() {
  ...
  return (
    <main className="design-system-page">
      ...
      <section><PageTitle eyebrow="PERSONNALITÉ" title="Mascotte et états" /><div className="mascot-library"><figure><img src={asset('mascot.png')} alt="Mascotte Referio" /><figcaption>Profil · impact local</figcaption></figure><figure><img src={asset('mascot-favorites.png')} alt="Mascotte avec boîte vide" /><figcaption>Favoris vides</figcaption></figure><figure><img src={asset('mascot-network.png')} alt="Mascotte et câble débranché" /><figcaption>Erreur réseau</figcaption></figure><figure><img src={asset('mascot-location.png')} alt="Repère endormi" /><figcaption>Localisation refusée</figcaption></figure></div></section>
      <section><PageTitle eyebrow="PLANCHES SOURCES" title="Navigation, catégories et gamification" body="Références maîtres conservées sans redessin." /><div className="reference-board-grid"><img src={asset('reference-navigation-actions.png')} alt="Planche des icônes de navigation et actions" /><img src={asset('reference-categories.png')} alt="Planche des icônes de catégories" /><img src={asset('reference-gamification.png')} alt="Planche des icônes de gamification" /></div></section>
